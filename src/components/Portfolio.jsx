...
const FocusedCard = ({ proj, need, setNeed }) => {
...
const ProjectsView = ({ focusedIndex, handleScroll, need, setNeed }) => (
    <div className="flex flex-col xl:flex-row justify-around gap-4 items-center">
        ...
        />
        <FocusedCard proj={portfolio_projects[focusedIndex]} need={need} setNeed={setNeed} />
        <SideCard
...
const Portfolio = ({ need, setNeed }) => {
    ...
    return (
        <div className="mt-12 flex flex-col gap-4 items-center">
            ...
            <ProjectsView focusedIndex={focusedIndex} handleScroll={handleScroll} need={need} setNeed={setNeed} />
